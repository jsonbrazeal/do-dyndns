...
## Fork jsonbrazeal/do-dyndns

* Added Google nameserver dig check before http checks to retrieve external IP address
* Added Google Cloud Messaging when external IP address changes